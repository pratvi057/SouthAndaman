...
map.getView().fit([10264510.777238, 1176668.205931, 10366480.017805, 1375510.621925], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Tourist Locations of SOUTH ANDAMAN</h2>';
        return titleElement;
    })(),
